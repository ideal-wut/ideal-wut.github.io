...
![时空数据库相关技术图2](/assets/images/research/时空数据库2.jpg)
...
![时空数据库相关技术图3](/assets/images/research/时空数据库3.jpg)
...
![时空数据库相关技术图6](/assets/images/research/时空数据库6.jpg)
...
![时空数据库相关技术图7](/assets/images/research/时空数据库7.jpg)

#### Workload-Aware Shortest Path Distance Querying in Road Networks （ICDE 2022）

WCF框架示例

![时空数据库相关技术图8](/assets/images/research/时空数据库8.jpg)
...
![时空数据库相关技术图9](/assets/images/research/时空数据库9.jpg)

#### SpeakNav: Voice-based Route Description Language Understanding for Template Driven Path Search （VLDB 2021）

![时空数据库相关技术图10](/assets/images/research/时空数据库10.jpg)

SpeakNav框架示例

![时空数据库相关技术图11](/assets/images/research/时空数据库11.jpg)
